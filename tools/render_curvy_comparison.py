...
# 2. Updated 12_Custom_Rod_Detent_Spring_01
...
axes[1].set_title("Reworked: 12_Custom_Rod_Detent_Spring_01", color='white', pad=10)
axes[1].tick_params(colors='white')

fig.patch.set_facecolor('#181818')
plt.tight_layout()
plt.savefig(os.path.join(ROOT_DIR, "tools", "side_by_side_curvy_v2.png"), dpi=200, facecolor=fig.get_facecolor())
print("Saved side_by_side_curvy_v2.png")
