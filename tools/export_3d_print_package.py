...
PARTS_MANIFEST = [
    ...
    {
        "id": 16,
        "source_file": "16_Custom_Internal_Barrel_Pin_01.stl",
        "export_filename": "16_Custom_Internal_Barrel_Pin_01.stl",
        "subassembly": "03_Internal_Barrel_And_Upper_Station",
        "plate": "Plate_2_Internal_Barrel_And_Springs",
        "color": "Black / Gunmetal",
    ...
    {
        "id": 17,
        "source_file": "17_Custom_Internal_Barrel_Pin_02.stl",
        "export_filename": "17_Custom_Internal_Barrel_Pin_02.stl",
        "subassembly": "03_Internal_Barrel_And_Upper_Station",
        "plate": "Plate_2_Internal_Barrel_And_Springs",
        "color": "Black / Gunmetal",
    ...
    },
    {
        ...
        "plate": "Plate_3_Rod_Assembly_And_Locks",
        "color": "Black / Gunmetal",
        "desc": "Full-depth middle rod with integral solid hinge yoke, open spring slot, and 45° self-supporting arch roof",
        "supports": "No (Brim recommended)",
    },
    {
        "id": 24,
...
BED_POSES = {
    ...
    "11_Custom_Internal_Barrel_Cap.stl": ([[1, 0, 0], [0, 0, 1], [0, -1, 0]], 0),
    ...
    "23_Custom_Rod_Middle.stl": ([[1, 0, 0], [0, 0, -1], [0, 1, 0]], 0),
...
def _write_readme():
    ...
    md_content = r"""# 🎯 Native Tactical/Spinner Hybrid Grenade Fidget Toy — 3D Printing & Assembly Guide
### Package {{PACKAGE}}
