...
# Right arm (x >= 0)
right_arm = p2.intersection(shapely.box(0.0, 15.0, 20.0, 50.0))

fig, ax = plt.subplots(figsize=(8, 14))

x, y = right_arm.exterior.xy
ax.fill(x, y, color='#999999', edgecolor='black', linewidth=1.5)

# If any holes
for interior in right_arm.interiors:
    ix, iy = interior.xy
...
ax.set_title("11 - Middle Spring v2 (Right Arm)", color='white')
ax.tick_params(colors='white')

plt.tight_layout()
plt.savefig(os.path.join(ROOT_DIR, "tools", "v2_right_arm_render.png"), dpi=200, facecolor=fig.get_facecolor())
print("Saved v2_right_arm_render.png")
