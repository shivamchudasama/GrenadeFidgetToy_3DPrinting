...
| the spring | value |
|---|---|
| foot | y 36.00 → 42.60, r 7.40 → 12.20 — the whole anchor, bearing on the slot's outer wall and seated on its floor; **4.00 mm** wide outboard of r 11.55 and **3.00 mm** inboard, which is the notch |
| arm | the reference outline, r 7.40 → 10.60, y 41.90 → 62.92, **3.00 mm** thick — the reference's own thickness |
| nose | 0.75 mm tip on flanks at the rack's own 49.37° half angle, apex **r 5.54**, at y 57.4; the flanks stop at **r 7.00** and the tongue closes back in at 45° onto the crown of the reference's own nose lobe at r 7.75 — **3.96 mm** tall |
| volume | 249.35 mm³, watertight, single body (thickened outer wall to ~1.05 mm, organic flexure curves with smooth S-curve inner transition & clean facet-free rail) |

**[D] How far the tongue runs, and why it is not an arrow-head.** The flanks only work where the rack can reach them, and the rack's outermost surface is its crest at **r 6.8901**. A point of the tongue at local radius u meets the rod at global u + d, where d is how far the spring is deflected — and d is never below the 0.209 mm the spring carries at its deepest seat, so nothing above local **r 6.681** can touch the rod at all. Running the matched flanks out to r 8.10 to reach the transplanted arm, as the first build did, therefore bought nothing and cost a great deal: they diverge at tan 49.37° = 1.165, so every further millimetre of radius adds **2.33 mm** of axial height, and the nose came out **6.52 mm** tall — two and a half times the 2.53 mm lobe it was copied from, and a spearhead rather than a nose. They now stop at **r 7.00**, past every radius the rack can reach and no further, and the tongue closes back in at 45° until it is inside the arm's own nose lobe, which carries the outline from r 7.75 outward. Nothing at or below r 7.00 moves by a micron: the rate is 0.631 N/mm either way, and the swept force is the same 2.26 N peak on 0.45 N at the seat with no dead band. The spring loses **7.52 mm³** and 2.56 mm of nose height for it.

**[M] The foot's inner face is one plane.** The reference's cut end is wider than its leaf, and mapped in it reaches **r 7.20** — 0.20 mm inboard of the foot's own inner face at 7.40. Unclipped it hung a **0.20 × 0.16 mm** lip off the bottom inside corner of every spring, a downward-facing overhang on the bore side, where the rod runs. It passed watertightness, body count, interference and insertion, because it fouls nothing; it was simply a burr. `arm_profile()` now clips the body to r ≥ 7.40 below the foot's top face, so the inner face is flush from y 36.00 to 42.60.

**[M] The foot is seated on the slot floor, and what float is left.** The slot is one constant section from its floor at **y 36.000** to the barrel top at 63.238 — a 3.50 mm neck inboard of r 11.50 and a 4.50 mm rib band from 11.50 to 12.30 — but the spring only fills that band over its foot; above 42.60 the arm pulls in to r 10.60 and the band is the volume the arm **swings through**, out to r 12.11 at full crest. It cannot be filled. So what locates the spring is the foot radially (12.20 against a 12.30 wall) and tangentially (0.25 mm per side in both bands), and the barrel floor and cap ceiling axially. The foot's bottom now lands **on** the floor at 36.00 rather than 0.302 mm above it, which is free — the foot is rigid, the floor is flat, and the arm is untouched: rate 0.631 N/mm, strain 0.831 %/mm and swing r 12.11 are all unchanged, at a cost of 4.52 mm³. What remains is **0.342 mm** of lift, from the spring's top at 62.916 to the cap's relief ceiling at 63.260, and that one is coupled to `ARM_SCALE_Y` — the arm's top height is what the 0.740 axial scale buys to land the click at the reference's 2.00 N. Measured against the barrel and cap together, the spring's axial float is now **+0.000 / +0.342 mm**, down from 0.647. It matters for repeatability, not force: the nose carries ~0.25 N radially per arm, so rack friction (~0.075 N) dwarfs the spring's own 0.0024 N weight and the springs walk to whichever end the rod last dragged them — 0.342 mm of backlash against a 3.177 mm tooth pitch, down from 20% of a tooth to 11%.
...
- **all three cap keys**, which sat in those follower slots. `11_Custom_Internal_Barrel_Cap` is the plain lobed disc left over. It still presses onto the barrel's top face by ~12 mm³ and it is what holds all four springs down — though over the slots it is relieved to **y 63.260**, and only outboard of r 12.55 does its underside sit at **y 63.205**, but its rotational lock is gone: turning the fingerless disc gives 10.7 .. 13.0 mm³ against the barrel at every angle, a preference and not a stop.
