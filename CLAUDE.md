...
- `tools/` — Python toolchain:
  ...
  - `build_modified_rotating_spring.py` — builds the refined Upper Shell Rotating Spring (`21_30`) with extended low-angle ski-tip glide ramp on Flank B (+3.5 mm, $R = 0.75\text{ mm}$ curl) eliminating counter-clockwise rotation wedging/jerk. Generates both Option 1 (Balanced Comfort, $\Delta t = 0.25\text{ mm}$) and Option 2 (Firm Click, $\Delta t = 0.35\text{ mm}$).
