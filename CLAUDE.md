...
- **Tactical Internal Spine & Upper Station**: `08 - Internal Barrel` capped by `11_Custom_Internal_Barrel_Cap` (with 3.60 mm slots at 90°/270° for dual-headed spring pass-through), carrying the top assembly (`18_27`, `19_28`, `20_29`, `21_30`). Two retention pins at 45° (`16_Custom_Internal_Barrel_Pin_01.stl`) and 135° (`17_Custom_Internal_Barrel_Pin_02.stl`) lock `18_27_Upper_Shell_Top.stl` axially to the barrel (16.70 mm³ interference at 1 mm lift), sleeved and trapped by `19_28_Upper_Shell_Gear` and `20_29_Upper_Shell_Lock_Ring`.
...
- **Dual-Pin Upper Shell Retention** (`v1.2`): The barrel carries four detent slots at 0°/90°/180°/270°. All three legacy pin channels (30°, 150°, 270°) are solidly filled, and clean retention pin cavities are cut at symmetric 45° and 135° azimuths, giving 3.50 mm solid wall clearance to all four spring slots. `16_Custom_Internal_Barrel_Pin_01.stl` (az 45°) and `17_Custom_Internal_Barrel_Pin_02.stl` (az 135°) insert through the Upper Shell Top side windows into the barrel channels, providing positive axial retention against lifting (16.70 mm³ interference at 1.0 mm lift). The 3 stock follower slots at 90°/210°/330° remain filled. The cap carries 3.60 mm pass-through channels at 90° and 270° to clear the dual-headed spring stalks while retaining the lower springs.
